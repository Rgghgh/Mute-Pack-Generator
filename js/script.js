$(document).ready(function () {
    ...
    $('[type=submit]').hover(showOldButton);
    $('[type=submit]').mouseleave(hideOldButton);
    $('#old-version').click(submitOldVersion);
...
function showOldButton() {
    $('#old-version').removeClass('hide');
    $('#old-version').addClass('show');
}

function hideOldButton() {
    setTimeout(function () {
        $('#old-version').removeClass('show');
        $('#old-version').addClass('hide');
    }, 2000);
}

function submitOldVersion() {
    $('[type=submit]').val("1.8");
    $('[type=submit]').click();
    $('[type=submit]').val("1.9");
}
